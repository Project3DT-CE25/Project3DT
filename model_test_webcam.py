...
PATH_TO_CKPT = os.path.join(HomePath, 'Face-Mask-Type-Detector', 'workspace', Model_dir, MODEL_NAME, 'frozen_inference_graph.pb')

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join(HomePath, 'Face-Mask-Type-Detector', 'workspace', 'annotations', 'label_map.pbtxt')
